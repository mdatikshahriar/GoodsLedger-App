...
public class ConsumerEditAccountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consumer_edit_account);

        profilePictureImageView = findViewById(R.id.activity_consumer_edit_account_profilePicture_ImageView);
        accountNameEditText = findViewById(R.id.activity_consumer_edit_account_accountName_EditText);
        accountEmailEditText = findViewById(R.id.activity_consumer_edit_account_accountEmail_EditText);
        accountPhoneNoEditText = findViewById(R.id.activity_consumer_edit_account_accountPhoneNo_EditText);
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, MainActivity.getLinks().getURL_updateAccount(),
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                try {
                                    ...
                                    Toast.makeText(ConsumerEditAccountActivity.this, "Account successfully updated!", Toast.LENGTH_SHORT).show();
                                } catch (JSONException e) {
                                    progressBar.setVisibility(View.GONE);
                                    e.printStackTrace();
                                    Toast.makeText(ConsumerEditAccountActivity.this, "Account updating failed! Error: " + response, Toast.LENGTH_SHORT).show();
                        ...
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                progressBar.setVisibility(View.GONE);
                                Toast.makeText(ConsumerEditAccountActivity.this, "Account updating failed! Error: " + error.toString(), Toast.LENGTH_SHORT).show();
                ...
                RequestQueue requestQueue = Volley.newRequestQueue(ConsumerEditAccountActivity.this);
