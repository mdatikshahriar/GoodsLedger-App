...
public class QueriedProductsAdapter extends RecyclerView.Adapter <RecyclerView.ViewHolder> {

    private ArrayList<Product> productsArray;

    QueriedProductsAdapter(ArrayList<Product> productsArray) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new QueriedProductsHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        QueriedProductsHolder queriedProductsHolder = (QueriedProductsHolder) holder;

        ImageView productQRCodeImageView = queriedProductsHolder.productQRCodeImageView;
        TextView productName = queriedProductsHolder.productName;
        TextView productType = queriedProductsHolder.productType;
        TextView productID = queriedProductsHolder.productID;
        ...
        queriedProductsHolder.productBatchID = product.getProductBatch();
        queriedProductsHolder.productSerialinBatch = product.getProductSerialinBatch();
        queriedProductsHolder.productManufacturingLocation = product.getProductManufacturingLocation();
        queriedProductsHolder.productManufacturingDate = product.getProductManufacturingDate();
        queriedProductsHolder.productExpiryDate = product.getProductExpiryDate();
    }
    ...
    private class QueriedProductsHolder extends RecyclerView.ViewHolder{
        ...
        public QueriedProductsHolder(@NonNull final View itemView) {
            super(itemView);
