...
public class ProductsAdapter extends RecyclerView.Adapter <RecyclerView.ViewHolder> {
    ...
    private class ProductsHolder extends RecyclerView.ViewHolder{
        ...
        public ProductsHolder(@NonNull final View itemView) {
            ...
            productQRCodeImageView = itemView.findViewById(R.id.item_manufacturer_products_productQRCode_ImageView);
            productLinearLayout = itemView.findViewById(R.id.item_manufacturer_products_LinearLayout);
            ...
            productID = itemView.findViewById(R.id.item_manufacturer_products_productID_TextView);
